...
<style>
    ...
    .page-title { font-size: 28px; font-weight: 700; color: #1a202c; }
    .btn-primary { background: #303b97; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; font-weight: 600; }
    ...
    .filter-label { font-size: 13px; color: #374151; margin-bottom: 8px; font-weight: 600; }
    .filter-select { width: 100%; padding: 10px; border: 1px solid #e5e7eb; border-radius: 8px; background: white; color: #1a202c; }

    .banners-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(350px, 1fr)); gap: 24px; }
    .banner-card { background: white; border: 1px solid #e5e7eb; border-radius: 14px; overflow: hidden; transition: transform 0.2s; }
    ...
    .banner-title { font-size: 18px; font-weight: 600; color: #1a202c; margin-bottom: 8px; }
    ...
    .banner-stats { display: flex; gap: 20px; margin: 16px 0; padding: 16px; background: #f9fafb; border-radius: 8px; }
    .stat-item { flex: 1; text-align: center; }
    .stat-item-value { font-size: 20px; font-weight: 700; color: #1a202c; }
...
@section('content')
@php
    // Safety check: Ensure stats array has all required keys
    $stats = $stats ?? [];
        ...
        <div class="banner-card">
            ...
            <div class="banner-content">
                ...
                <div class="banner-actions">
                    <a href="{{ route('agent.banner.edit', $banner->id) }}" class="btn btn-edit">
                    ...
                    <a href="{{ route('agent.banner.analytics', $banner->id) }}" class="btn btn-analytics">
                        <i class="fas fa-chart-line"></i>
                    </a>

                    <form method="POST" action="{{ route('agent.banner.delete', $banner->id) }}" style="display: inline;" onsubmit="return confirm('Delete this banner?')">
                        @csrf
                        @method('DELETE')
