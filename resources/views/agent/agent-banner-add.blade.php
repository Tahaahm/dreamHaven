    ...
    <div class="form-card">
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-input" required value="{{ old('title') }}" placeholder="Enter banner title" minlength="5" maxlength="255">
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-textarea" placeholder="Enter banner description" maxlength="1000">{{ old('description') }}</textarea>
        ...
        <div class="form-section">
            ...
            <div class="image-upload" onclick="document.getElementById('banner-image').click()">
                ...
                <p style="color: #374151; font-size: 15px;">Click to upload banner image</p>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="url" name="link_url" class="form-input" value="{{ old('link_url') }}" placeholder="https://example.com" maxlength="500">
