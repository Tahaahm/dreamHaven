    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-2">Update details for <span class="font-semibold text-indigo-600">{{ $category->name }}</span>.</p>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div class="p-8 space-y-8">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mb-4">Manage the representative image for this category.</p>
                        ...
                        <div class="relative group">
                            ...
                            <label for="category_image"
                                ...
                                {{-- Upload State (Visible if no image, or hidden behind preview) --}}
                                <div id="upload-placeholder" class="{{ $category->image ? 'hidden' : '' }} text-center transition-all duration-300 group-hover:scale-105">
                                    ...
                                    <p class="text-base font-semibold text-gray-900">Click to upload new image</p>
                                    <p class="text-sm text-gray-500 mt-1">SVG, PNG, JPG or GIF (Max. 400x400px)</p>
                                </div>

                                {{-- Preview State (Shows current image or new preview) --}}
                                <div id="image-preview-wrapper" class="{{ $category->image ? '' : 'hidden' }} absolute inset-0 w-full h-full">
                                    <img id="image-preview" src="{{ $category->image }}" class="w-full h-full object-cover">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="name" value="{{ old('name', $category->name) }}" required placeholder="e.g. Plumbing Services"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="subtitle" value="{{ old('subtitle', $category->subtitle) }}" placeholder="e.g. Pipes, leaks, and installations"
                                           class="w-full pl-11 pr-4 py-3 bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-xl focus:ring-2 focus:ring-indigo-500 focus:bg-white focus:border-transparent transition-all placeholder-gray-400">
                                </div>
                            </div>
