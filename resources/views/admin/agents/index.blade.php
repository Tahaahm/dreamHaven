...
<div class="dm-page">
  ...
  @php
    $computeExpiry = function ($agent) {
      ...
      return compact('sub','end','start','days','active','expired','expiring','pct','dash','circumference','ringColor','labelColor','dateClass');
    };
  @endphp
              ...
              <div class="dm-ring-wrap" aria-hidden="true">
                <svg class="dm-ring-svg" viewBox="0 0 36 36">
                  ...
                  <circle class="dm-ring-fill" cx="18" cy="18" r="15"
                    stroke="{{ $ringColor }}"
                    stroke-dasharray="{{ $expired ? 0 : $dash }} {{ $circumference }}"/>
                  @endif
                </svg>
