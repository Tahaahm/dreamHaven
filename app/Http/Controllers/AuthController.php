...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        // 2️⃣ Try logging in as an Agent (Fallback logic)
        ...
        // 3️⃣ Invalid login:
        // We use back() and pass 'portal_type' so the frontend JS remembers which card was selected!
        return back()
            ->withInput($request->only('email', 'remember', 'portal_type'))
