...
class SmartStripService
{
    ...
    private function tryResumeSearch(string $userId, array $signals, string $lang): ?array
    {
        ...
        // Build property query from filter signal
        ...
        // "New since last visit" — only count properties added after last filter signal
        ...
        // Build label parts (e.g. "Villa · Rent · Erbil")
        $labelParts = array_filter([
            $filtersApplied['property_type'] ?? null,
            isset($filtersApplied['listing_type'])
                ? ucfirst($filtersApplied['listing_type'])
                : null,
