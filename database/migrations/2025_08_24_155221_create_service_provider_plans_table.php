...
return new class extends Migration
{
    ...
    {
        Schema::create('service_provider_plans', function (Blueprint $table) {
            // Primary identifier
            $table->string('id')->primary(); // Using string ID like "basic_advertiser_plan"
            ...
            $table->integer('advertisement_slots')->default(1);
            $table->integer('featured_placement_days')->default(0);
    ...
    {
        Schema::dropIfExists('service_provider_plans');
    }
};
